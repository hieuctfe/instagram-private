...
(function () { return __awaiter(_this, void 0, void 0, function () {
    var ig, auth, followersFeed, wholeResponse, items, thirdPageItems, feedState, fourthPageItems;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, followersFeed.request()];
            case 2:
                wholeResponse = _a.sent();
            ...
            case 3:
                ...
                return [4 /*yield*/, followersFeed.items()];
            case 4:
                thirdPageItems = _a.sent();
                feedState = followersFeed.serialize();
                // console.log(feedState);
                followersFeed.deserialize(feedState);
                return [4 /*yield*/, followersFeed.items()];
            case 5:
                fourthPageItems = _a.sent();
                ...
                followersFeed.items$.subscribe(function (followers) { return console.log(followers); }, function (error) { return console.error(error); }, function () { return console.log('Complete!'); });
                return [2 /*return*/];
        }
    });
}); })();
